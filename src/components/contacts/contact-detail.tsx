...
export function ContactDetail({
  ...
  const isOverdue = contact.nextFollowUpDate
    ? contact.nextFollowUpDate <= new Date().toLocaleDateString('en-CA')
    : false
          ...
          <div className="bg-white rounded-lg border border-[oklch(90%_0.014_254)] overflow-hidden">
            ...
            {isOverdue && (
              <div className="mx-4 mt-3 flex items-center gap-2 rounded-md bg-[oklch(95%_0.040_25)] border border-[oklch(88%_0.06_25)] px-3 py-2 text-[12px] font-600 text-[oklch(44%_0.21_25)]">
                ...
                เลย Follow-up {Math.floor((Date.now() - new Date(contact.nextFollowUpDate!).getTime()) / 86400000)} วัน
              </div>
            )}
            ...
            <div className="grid grid-cols-3 gap-2 p-4 border-b border-[oklch(90%_0.014_254)]">
              ...
              <button onClick={handleDelete} disabled={deleting}
                className="flex flex-col items-center gap-1.5 py-3 rounded-lg border border-[oklch(88%_0.04_25)] bg-[oklch(98%_0.010_25)] text-[11px] font-700 text-[oklch(60%_0.12_25)] hover:bg-[oklch(95%_0.040_25)] transition-colors disabled:opacity-50">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg>
                ลบ
              </button>
            </div>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white rounded-lg border border-[oklch(90%_0.014_254)] overflow-hidden">
            <div className="px-5 py-3.5 border-b border-[oklch(90%_0.014_254)] flex items-center gap-2">
              ...
              <span className="ml-auto rounded-full bg-[oklch(93%_0.04_265)] px-2 py-0.5 text-[11px] font-700 text-[oklch(42%_0.20_265)]">{linkedTasks.length}</span>
            </div>
            {linkedTasks.length === 0 ? (
              <div className="px-5 py-6 text-center">
                <p className="text-[12px] text-[oklch(68%_0.016_254)]">ยังไม่มี task ที่เชื่อมกับ contact นี้</p>
              </div>
            ) : (
              <div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {task.dueDate && (
                        <p className="text-[11px] text-[oklch(65%_0.016_254)]">
                          ครบกำหนด {new Date(task.dueDate).toLocaleDateString('th-TH', { day: 'numeric', month: 'short' })}
                        </p>
                      )}
                    </div>
          ...
          <div className="bg-white rounded-lg border border-[oklch(90%_0.014_254)] overflow-hidden">
            <div className="px-5 py-3.5 border-b border-[oklch(90%_0.014_254)] flex items-center gap-2">
              ...
              <span className="text-[13px] font-700 text-[oklch(18%_0.012_254)]">Events</span>
              <span className="ml-auto rounded-full bg-[oklch(93%_0.04_265)] px-2 py-0.5 text-[11px] font-700 text-[oklch(42%_0.20_265)]">{linkedEvents.length}</span>
            </div>
            {linkedEvents.length === 0 ? (
              <div className="px-5 py-6 text-center">
                <p className="text-[12px] text-[oklch(68%_0.016_254)]">ยังไม่มี event ที่เชื่อมกับ contact นี้</p>
              </div>
            ) : (
              <div>
                {linkedEvents.map(ev => {
                  ...
                  return (
                    <div key={ev.id} className="flex items-start gap-3 px-5 py-2.5 border-b border-[oklch(90%_0.014_254)] last:border-none">
                      ...
                      {!isPast && (
                        <span className="shrink-0 rounded-full bg-[oklch(95%_0.038_160)] px-2 py-0.5 text-[10px] font-600 text-[oklch(42%_0.17_160)]">กำลังจะมาถึง</span>
                      )}
                    </div>
                  )
                })}
